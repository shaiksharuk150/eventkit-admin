...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex-shrink-0 flex flex-col gap-1.5 p-4", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    ...
    className={cn(
        "flex-shrink-0 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 p-4",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex-grow overflow-y-auto px-4", className)}
    {...props}
  />
))
